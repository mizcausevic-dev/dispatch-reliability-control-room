...
This repository is a **reference control plane** for dispatch reliability,
handoff-risk triage, and route-adherence posture across logistics/operations
workflows. It ships synthetic, non-sensitive sample data only. It is not a
production system of record and should not be deployed with real dispatch,
driver, or customer data without an independent security review.
